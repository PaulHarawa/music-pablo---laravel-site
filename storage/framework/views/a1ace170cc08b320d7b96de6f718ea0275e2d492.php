        ...
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="/all-albums">All Albums</a></li>
    ...
    <section id="topten">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header section-header-new">
          <br>
          <h3 class="text-uppercase">Albums
          </h3>
        </header>
        <br>
        ...
        foreach ($allAlbums as $albumName) {
...
<?php /**PATH D:\musicworld\resources\views/albums.blade.php ENDPATH**/ ?>