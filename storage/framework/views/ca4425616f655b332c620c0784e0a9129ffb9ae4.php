        ...
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li class="dropdown"><a href="#" class="active"><span>Genre</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header section-header-new">
          ...
          <h3 class="text-uppercase">
            ...
            if(empty($genreAlbums)){
              $first = "No album(s) found";
            }
              else{

              foreach ($genreAlbums as $album) {

                $grab = $album->name;

                $grabber = DB::select('select * from albums where name = ? LIMIT 1', [$grab]);

                  foreach($grabber as $genreOne){
                    $albumGenre = $genreOne->genre;
                  }
                }
                $first = $albumGenre.' Albums';
              }
              echo $first;
            ?>
        ...
        foreach ($genreAlbums as $albumName) {
...
<?php /**PATH D:\musicworld\resources\views/genrealbums.blade.php ENDPATH**/ ?>