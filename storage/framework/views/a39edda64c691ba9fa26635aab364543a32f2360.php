      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row topten-cols">
          ...
          <?php
            ...
            $songDetails = DB::select('select * from songs where id = ?', [$id]);
            ...
            foreach ($songDetails as $song) {
                ...
                $combi = $artist.'-profile';

                $comb1 = strtr($combi," '","--");

                $songGenre = $genre.'-songs';
                $artistGenre =  $genre2.'-artists';

            echo"
            <div class='col-md-5 mx-auto'>
              <div class='topten-col1'>
                <div class='img mx-auto'>
                  <img src='../artworks/$artwork' alt='' class='img-fluid'>
                </div>
                <span class='caption text-white text-capitalize'>$artist - $title<span>
                <h2 class='title'>
                  <div class='col-12'>
                    <canvas id='progress' height='7'></canvas>
                      <audio id='audio' ontimeupdate='updateBar()' src='../songs/$songFile'>
                      </audio>
                      <br>
                      <span class='timeX'>
                      ...
                      <button id='audioControl' onclick='togglePlaying(),played()' class='btn btn-success btn-sm'>Play</button>
                        ...
                        <a name='download' class='btn btn-sm btn-success download' onclick='updateDownloads()' id='downloadButton' href='/download/{$id}/$comb'>Download</a>
                        <br>
                        ...
                        <span class='captionII'>
                          ...
                          <br/><br/>
                          <span class='tags'> T A G S </span><br/>
                          <a href='/artist/{$artistid}/{$comb1}'><span class='bi bi-tag'></span> $artist songs</a>
                          <br/>
                          <a href='/$songGenre'><span class='bi bi-tag'></span> $genre songs</a>
                          <br/>
                          <a href='/$artistGenre'><span class='bi bi-tag'></span> $genre2 artists</a>
                        </span>
                      <br>
                      <br>
...
<?php /**PATH D:\musicworld\resources\views/song.blade.php ENDPATH**/ ?>