        ...
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li class="dropdown"><a href="#"  class="active"><span>Search</span> <i class="bi bi-chevron-down"></i></a>
  ...
  <main id="main">
    ...
    <section id="topten">
      <div class="container" data-aos="fade-up">
        ...
        foreach ($results3 as $aG) {

          $albumGrabber = $aG->name;

          $albumDetails = DB::select('select * from albums where name = ? LIMIT 1', [$albumGrabber]);
            ...
            <div class='col-md-4'>
              <div class='topten-col'>
                <div class='cont'>
                  ...
                  <a class='bg-transparent border-link text-capitalize' name='song' href='/album/{$name}/{$comb}'>$artist - $name <span class='bi bi-play-circle iconx'></span>
                  <br>
...
<?php /**PATH D:\musicworld\resources\views/search.blade.php ENDPATH**/ ?>