    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-new">
                <div class="card-header text-light"><?php echo e(__('Register')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="about" class="col-md-4 col-form-label text-md-end"><?php echo e(__('About')); ?></label>

                            <div class="col-md-6">

                                <textarea id="about" class="form-control <?php $__errorArgs = ['about'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="about" value="<?php echo e(old('about')); ?>" required autocomplete="about" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="picture" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Picture')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <br><br>
                                Already Registered? <a class="btn btn-sm btn-light" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login Now')); ?></a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\musicworld\resources\views/auth/register.blade.php ENDPATH**/ ?>