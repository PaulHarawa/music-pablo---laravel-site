      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header section-header-new">
          ...
          <?php
            ...
            $albumDetails = DB::select('select * from albums where name = ? LIMIT 1', [$aName]);

            foreach ($albumDetails as $artist) {
        ...
        <div class="row topten-cols">
          ...
          <div class="col-12 profile-cont ali">
            ...
            $td = DB::select('select downloads from albums where name = ?', [$aName]);

            $darray = array();

            foreach($td as $tds){
              array_push($darray, $tds->downloads);
            }

            $totalDownloads = array_sum($darray);
            ...
            <div class='col-12 col-md-6 image text-center'>
              <img src='../../albumsartworks/$artwork' alt='' class='img-fluid profile'>
            </div>
            <div class='col-12 col-md-4 captions'>
              <br>
              <span class='profile-caption'>Artist </span><br><span class='profile-detail'>$artist</span><br><br>

              <span class='profile-caption'>Genre </span><br><span id='newView' class='profile-detail'>$genre</span>
              <br><br>
              <span class='profile-caption'>Tracks </span><br><span class='profile-detail'>$noa</span><br><br>
              <span class='profile-caption'>Total Downloads </span><br><span class='profile-detail'>$totalDownloads</span><br><br>
              <span class='profile-caption'><a name='download' class='btn btn-sm btn-primary download' id='downloadButton' href='/download-zip/{$id}/$comb'>Download Zip</a></span><br><br>
            </div>
        ...
        echo "<span class='col-12 text-white text-center text-uppercase'><br><br>Songs<br><br><br></span>";

          $aName = $albumName;

          $albumDetails = DB::select('select * from albums where name = ? ORDER BY id', [$aName]);

          foreach ($albumDetails as $song) {
            ...
            <div class='col-md-4'>
              <div class='topten-col'>
                <div class='cont'>
                  ...
                  <a class='bg-transparent border-link text-capitalize' name='song' href='/album-tracks/{$songId}/{$comb}'>$artist - $title <span class='bi bi-play-circle iconx'></span>
                  <br>
...
<?php /**PATH D:\musicworld\resources\views/album.blade.php ENDPATH**/ ?>